		...
		shoping:function(options){
			...
			var S={
				...
				addIcon:function(){
					...
					var icon = '<div id="cartIcon" style="width:50px;height:50px;padding:2px;overflow:hidden;position:absolute;z-index:890;'+$options.iconCSS+'"><img src="'+$options.iconImg+'" width="50" height="50" style="border-radius: 50px 50px 50px 50px" /></div>';
					return icon;
				}
			};
			S.init();
